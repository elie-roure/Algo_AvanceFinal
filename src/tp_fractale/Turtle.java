package tp_fractale; /**AUTHOR: NICHOLAS SEWARD
...
/**
 * tp_fractale.Turtle is a selfcontained class that will allow students to make
...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    private static void init()
    {
        ...
        window = new JFrame("tp_fractale.Turtle");
        icon = new ImageIcon();
        setupBuffering();
...
//        System.out.println(Arrays.toString(fontNames));
     ...
     * of the applet you need to place <code>tp_fractale.Turtle.startApplet(this);</code>.
     ...
     * You don't need to use this outside of the tp_fractale.Turtle.java file.
     *
 ...
 */
   ...
   /**
            ...
            for(Method m : Class.forName(className).getDeclaredMethods())
            {
                if (m.getName().equals(methodName))
                {
                    ...
                    for(Class paramType : m.getParameterTypes())
                    {
                        ...
                        if (!paramType.getName().equals("double") && !paramType.getName().equals("java.lang.Double") && !paramType.getName().equals("tp_fractale.Turtle"))
                        {
                            works=false;
                            break;
                        }
        ...
        try
        {
            ...
            for(Method m : Class.forName(className).getDeclaredMethods())
            {
                if (m.getName().equals(methodName))
                {
                    ...
                    {
                        //System.out.println(paramType.getName());
                        if (!paramType.getName().equals("java.lang.String") && !paramType.getName().equals("tp_fractale.Turtle"))
                        {
                            works=false;
                            break;
                        }
    ...
    {
        //tp_fractale.Turtle bob = new tp_fractale.Turtle();
        /*for(int i=0;i<360;i++)
        {
            bob.forward(i*1.25);
            bob.left(90.25);
